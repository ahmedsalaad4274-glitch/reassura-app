  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentCol}>
        <Text style={styles.userName}>{footprint.user_name}</Text>
...
const styles = StyleSheet.create({
  ...
  contentCol: { flex: 1 },
  userName: { fontFamily: FONTS.bodyMedium, fontSize: 14, color: COLORS.white },
  statusText: { fontFamily: FONTS.body, fontSize: 13, color: COLORS.textBody, marginTop: 2 },
  timeText: { fontFamily: FONTS.body, fontSize: 11, color: COLORS.textMuted, marginTop: 2 },
