...
const s = StyleSheet.create({
  ...
  qaSafe: { flex: 1, borderRadius: 16, padding: 16, paddingVertical: 18, alignItems: 'center', gap: 6, backgroundColor: 'rgba(61,90,153,0.12)', borderWidth: 1.5, borderColor: 'rgba(61,90,153,0.35)', position: 'relative', overflow: 'visible' },
  qaOuterRing: { position: 'absolute', top: -3, left: -3, right: -3, bottom: -3, borderRadius: 19, borderWidth: 1.5, borderColor: 'rgba(61,90,153,0.2)' },
  qaArrowDot: { position: 'absolute', top: 8, right: 8, width: 16, height: 16, backgroundColor: '#3D5A99', borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  qaIcon: { fontSize: 24 },
  qaSafeText: { fontSize: 11, color: '#8AAAE0', fontWeight: '600' },
  qaNight: { flex: 1, borderRadius: 16, padding: 16, paddingVertical: 18, alignItems: 'center', gap: 6, backgroundColor: 'rgba(201,168,76,0.08)', borderWidth: 1.5, borderColor: 'rgba(201,168,76,0.22)' },
  qaNightText: { fontSize: 11, color: 'rgba(255,255,255,0.65)', fontWeight: '600' },
  qaCheck: { flex: 1, borderRadius: 16, padding: 16, paddingVertical: 18, alignItems: 'center', gap: 6, backgroundColor: 'rgba(122,158,135,0.08)', borderWidth: 1.5, borderColor: 'rgba(122,158,135,0.22)', position: 'relative', overflow: 'hidden' },
  qaCheckText: { fontSize: 11, color: 'rgba(255,255,255,0.65)', fontWeight: '600' },
  qaCheckPulse: { position: 'absolute', top: 8, right: 8, width: 6, height: 6, borderRadius: 3, backgroundColor: COLORS.sageGreen },
  qaDesc: { fontSize: 9, color: 'rgba(255,255,255,0.3)', textAlign: 'center' },
  // Glass card
