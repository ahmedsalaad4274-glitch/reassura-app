...
const s = StyleSheet.create({
  ...
  // I'm Home
  imHomeGrad: { borderRadius: 20, padding: 18, overflow: 'hidden' },
  imHomeIcon: { fontSize: 32, marginBottom: 8 },
  imHomeRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  imHomeTitle: { fontFamily: FONTS.headingBold, color: COLORS.white, fontSize: 21, letterSpacing: -0.3 },
  imHomeSub: { fontSize: 11, color: 'rgba(255,255,255,0.65)', marginTop: 2 },
  tapRing: { width: 40, height: 40, borderRadius: 20, borderWidth: 2, borderColor: 'rgba(255,255,255,0.4)', alignItems: 'center', justifyContent: 'center' },
  tapArrow: { color: COLORS.white, fontSize: 16 },
  // Quick Actions
  qaRow: { flexDirection: 'row', gap: 7 },
  qaSafe: { flex: 1, borderRadius: 15, padding: 12, alignItems: 'center', gap: 5, backgroundColor: 'rgba(61,90,153,0.15)', borderWidth: 1.5, borderColor: 'rgba(61,90,153,0.4)', position: 'relative', overflow: 'visible' },
  qaOuterRing: { position: 'absolute', top: -4, left: -4, right: -4, bottom: -4, borderRadius: 19, borderWidth: 1.5, borderColor: 'rgba(61,90,153,0.25)' },
  qaArrowDot: { position: 'absolute', top: 7, right: 7, width: 14, height: 14, backgroundColor: '#3D5A99', borderRadius: 7, alignItems: 'center', justifyContent: 'center' },
  qaArrowText: { color: COLORS.white, fontSize: 7 },
  qaIcon: { fontSize: 20 },
  qaSafeText: { fontSize: 9, color: '#8AAAE0', fontWeight: '500' },
  qaNight: { flex: 1, borderRadius: 15, padding: 12, alignItems: 'center', gap: 5, backgroundColor: 'rgba(201,168,76,0.08)', borderWidth: 1.5, borderColor: 'rgba(201,168,76,0.22)' },
  qaNightText: { fontSize: 9, color: 'rgba(255,255,255,0.6)', fontWeight: '500' },
  qaCheck: { flex: 1, borderRadius: 15, padding: 12, alignItems: 'center', gap: 5, backgroundColor: 'rgba(122,158,135,0.08)', borderWidth: 1.5, borderColor: 'rgba(122,158,135,0.22)' },
  qaCheckText: { fontSize: 9, color: 'rgba(255,255,255,0.6)', fontWeight: '500' },
  // Glass card
