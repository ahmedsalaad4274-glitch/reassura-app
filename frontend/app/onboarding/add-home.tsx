...
const styles = StyleSheet.create({
  ...
  addressLabel: { fontFamily: ONBOARDING.bodyBold, color: ONBOARDING.white, fontSize: 11 },
  addressName: { fontFamily: ONBOARDING.body, color: 'rgba(255,255,255,0.5)', fontSize: 11 },
  addressNote: { fontFamily: ONBOARDING.body, color: ONBOARDING.sage, fontSize: 8, marginTop: 2 },
});
